        ...
        <nav class="space-y-4">
            <div>
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <NuxtLink to="/profile/my-reviews" class="block px-4 py-2 text-sm rounded-md"
                            :class="isActive('/profile/my-reviews') ? 'font-semibold text-blue-600 bg-blue-100' : 'text-gray-700 hover:bg-gray-100'">
                            เช็ครีวิวของตัวเอง
                        </NuxtLink>
                    </li>
                </ul>
